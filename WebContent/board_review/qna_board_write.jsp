...
<section id="writeForm">
	<h2>게시판 글 등록</h2>
	<form action="boardWritePro.bor" method="post" enctype="multipart/form-data" name="boardform">
		<table>
			<tr>
		...
		<section id="commandCell">
			...
			<input type="button" value="목록으로" onclick="window.location.href='boardList.bor'"/>
		</section>
	</form>
</section>
</body>
