...
<section id="listForm">
	<h2>Q&A 게시판</h2>
	<h4><a href="boardWriteForm.boq">게시판 글쓰기</a></h4>
	<table>
<c:if test="${articleList != null && pageInfo.listCount > 0 }">
		...
		<tr>
			...
			<td>
				...
				<a href="boardDetail.boq?board_num=${article.BOARD_NUM }&page=${pageInfo.page}">
...
<section id="pageList">
	...
	<c:otherwise>
		<a href="boardList.boq?page=${pageInfo.page-1 }">[이전]</a>&nbsp;
	</c:otherwise>
	</c:choose>
	...
	<c:forEach var="a" begin="${pageInfo.startPage }" end="${pageInfo.endPage }" step="1" >
		...
		<c:otherwise>
			<a href="boardList.boq?page=${a }">[${a}]</a>&nbsp;
		</c:otherwise>
		</c:choose>
	</c:forEach>
	...
	<c:otherwise>
		<a href="boardList.boq?page=${pageInfo.page+1}">[다음]</a>
	</c:otherwise>
	</c:choose>
</section>
</c:if>
